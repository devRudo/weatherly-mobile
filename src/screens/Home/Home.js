            ...
            <View
              ...
              <View
                          ...
                          transform: [
                            {
                              rotate: `${
                                -45 +
                                currentLocation?.weatherData?.current?.wind_deg
                              }deg`,
                            },
                          ],
                        }}></Icon>
                ...
                <View
                  ...
                  <View>
                    ...
                    <Text>
                      {moment(
                        currentLocation?.weatherData?.daily?.[0]?.sunset * 1000,
                      ).format('hh:mm A')}
                    </Text>
                  </View>
                  <View>
              ...
              <View
                ...
                <View
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    <Text>
                      {temperatureUnit === 'C'
                        ...
                        : convertTemp(
                            currentLocation?.weatherData?.current?.feels_like,
                            'C',
                            'F',
                          )}
                    </Text>
                  ...
                  <Text>{currentLocation?.weatherData?.current?.clouds}%</Text>
                  <Text>
